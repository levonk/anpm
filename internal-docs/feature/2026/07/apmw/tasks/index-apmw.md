...
| Story ID | Title | Phase | Status | Assignee | Parallel-safe | Dependencies | Dependants | Modules | Branch |
|---|---|---:|---|---|---|---|---|---|---|
| 03-001 | Version resolution engine (pinned/engine/latest/latest-minor + min-age-days supply-chain defense) | 03 | [~] In-Progress |  | true | 01-001, 01-005, 02-001 | 04-001 | src/version/ | feature/current/apmw/story-03-001-version-resolution |
