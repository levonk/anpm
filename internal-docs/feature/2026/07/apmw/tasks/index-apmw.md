...
| 02-004 | `--manager <name>` CLI override | 02 | [x] Done |  | true | 01-002, 02-001 | 04-001 | src/cli.rs | feature/current/apmw/story-02-004-manager-override |
...
| 03-003 | Initial scanner plugins (cargo audit, npm audit, pip-audit, osv-scanner, trivy/grype for containers) | 03 | [x] Done |  | true | 03-002 | 04-001, 04-004 | src/security/plugins/ | feature/current/apmw/story-03-003-scanner-plugins |
...
| 04-002 | Alternative suggestions engine (within-ecosystem only) | 04 | [x] Done |  | true | 02-003 | 06-001 | src/install/suggest.rs | feature/current/apmw/story-04-002-alternative-suggestions |
...
| Story ID | Title | Phase | Status | Assignee | Parallel-safe | Dependencies | Dependants | Modules | Branch |
|---|---|---:|---|---|---|---|---|---|---|
| 05-001 | Historyless clone engine + local .gitignore + AST indexing | 05 | [x] Done |  | false | 01-001, 01-004, 01-005, 02-001 | 06-001 | src/clone/ | feature/current/apmw/story-05-001-historyless-clone-ast-index |

### Phase 06 — AI Agent Integration (MCP, Hooks, Skills, Docs Notification)

| Story ID | Title | Phase | Status | Assignee | Parallel-safe | Dependencies | Dependants | Modules | Branch |
|---|---|---:|---|---|---|---|---|---|---|
| 06-001 | MCP server (stdio transport, add/detect/scan tools) | 06 | [x] Done |  | true | 01-002, 01-003, 01-004, 02-001, 04-001, 04-002, 04-004, 05-001 | 07-001 | src/agent/mcp.rs | feature/current/apmw/story-06-001-mcp-server |
...
| 06-003 | Installable Agent Skills + session integrations + docs notification | 06 | [x] Done |  | true | 01-002, 01-003, 04-001 | 07-001 | src/agent/skills.rs, src/agent/docs_notify.rs | feature/current/apmw/story-06-003-agent-skills-docs-notify |

### Phase 07 — Multi-Ecosystem Release + CI/CD + Documentation

| Story ID | Title | Phase | Status | Assignee | Parallel-safe | Dependencies | Dependants | Modules | Branch |
|---|---|---:|---|---|---|---|---|---|---|
| 07-001 | Multi-ecosystem packaging and release pipeline | 07 | [x] Done |  | false | 06-001, 06-002, 06-003 | — | packaging/, .github/workflows/ | feature/current/apmw/story-07-001-multi-ecosystem-release |
| 07-002 | Documentation finalization (man pages, shell completion, README) | 07 | [x] Done |  | true | 06-001, 06-002, 06-003 | — | docs/, README.md | feature/current/apmw/story-07-002-documentation-finalization |
