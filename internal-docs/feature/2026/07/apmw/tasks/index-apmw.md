...
| Story ID | Title | Phase | Status | Assignee | Parallel-safe | Dependencies | Dependants | Modules | Branch |
|---|---|---:|---|---|---|---|---|---|---|
| 06-001 | MCP server (stdio transport, add/detect/scan tools) | 06 | [~] In-Progress |  | true | 01-002, 01-003, 01-004, 02-001, 04-001, 04-002, 04-004, 05-001 | 07-001 | src/agent/mcp.rs | feature/current/apmw/story-06-001-mcp-server |
